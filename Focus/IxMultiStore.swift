...
public struct IxMultiStore<O, I, A> {
	...
	public func extend<E, B>(_ f : (IxMultiStore<E, I, A>) -> B) -> IxMultiStore<O, E, B> {
		return self ->> f
	}
